            ...
            <div class="col-11 py-5 py-lg-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-auto flex-grow-1">
                        <nav>
                            <ul class="d-flex flex-column align-items-center justify-content-sm-center justify-content-lg-start flex-sm-row gap-3 my-5 ms-lg-5">
                    ...
                    <div class="col-lg-auto">
                        <ul class="d-flex gap-4 justify-content-center justify-content-lg-start">
                            <li>
